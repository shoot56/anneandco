...
<div id="page" class="site site-lp-uxui">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'anneco' ); ?></a>

	<header class="site-header site-header--top site-header--landing-uxui <?php echo $args['header_class']; ?> <?php echo $args['header_color']; ?>">
		<div class="container">
			<div class="site-header__frame">
				...
				<nav class="main-navigation-landing">
					<a href="#" data-target=".lp-contact-section" class="jump-to btn secondary-btn secondary-btn--navy btn--sm-mob">
						...
						<?php else: ?>
							<span class="secondary-btn__text">Start a project</span>
