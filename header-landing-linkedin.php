...
<div id="page" class="site">
	...
	<header class="site-header site-header--top site-header--landing-linkedin <?php echo $args['header_class']; ?> <?php echo $args['header_color']; ?>">
		<div class="container">
			<div class="site-header__frame">
				...
				<nav class="main-navigation-landing">
					<a href="#" data-target=".lp-contact-section" class="jump-to btn secondary-btn secondary-btn--navy">
