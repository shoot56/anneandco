...
<div id="page" class="site site-lp-google">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'anneco' ); ?></a>

	<header class="site-header site-header--top site-header--landing-google <?php echo $args['header_class']; ?> <?php echo $args['header_color']; ?>">
		<div class="container">
			<div class="site-header__frame">
				<strong class="logo"><a href='<?php echo esc_url( home_url( '/' ) ); ?>' rel="home"><?php bloginfo( 'name' ); ?></a></strong>
				<nav class="main-navigation-landing">
					<a href="#" data-target=".lp-contact-section" class="jump-to btn secondary-btn secondary-btn--white btn--sm-mob">
						<?php if (get_field( 'header_link_text' )): ?>
							<span class="secondary-btn__text"><?php the_field( 'header_link_text' ); ?></span>
						<?php else: ?>
	...
	<div class="site-header site-header--stick">
		<div class="container">
			<div class="site-header__frame">
				<strong class="logo"><a href='<?php echo esc_url( home_url( '/' ) ); ?>' rel="home"><?php bloginfo( 'name' ); ?></a></strong>
				<nav class="main-navigation-landing">
					<a href="#" data-target=".lp-contact-section" class="jump-to btn secondary-btn secondary-btn--navy btn--sm-mob">
						<?php if (get_field( 'header_link_text' )): ?>
							<span class="secondary-btn__text"><?php the_field( 'header_link_text' ); ?></span>
						<?php else: ?>
							<span class="secondary-btn__text">Contact Us</span>
