...
<div id="page" class="site">
	...
	<header class="site-header site-header--top <?php echo $args['header_class']; ?> <?php echo $args['header_color']; ?>">
		<div class="container">
						...
						<?php if ( have_rows( 'header_contact_blocks', 'option' ) ) : ?>
							<?php while ( have_rows( 'header_contact_blocks', 'option' ) ) : the_row(); ?>
								<div class="header-contacts__info">
									<div class="header-contacts__label"><?php the_sub_field( 'block_label' ); ?></div>

									<?php if (get_sub_field( 'block_content' ) == 'buttons'): ?>
												...
												<?php while ( have_rows( 'content' ) ) : the_row(); ?>
													...
													<?php if ( $button ) : ?>
														<a href="<?php echo esc_url( $button['url'] ); ?>" target="<?php echo esc_attr( $button['target'] ); ?>" class="btn secondary-btn secondary-btn--navy">
															...
															<span class="secondary-btn__icon"><svg class="svg-icon" width="16" height="16"><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/images/icons.svg#<?php the_sub_field( 'button_icon_name' ); ?>"></use></svg></span>
														</a>
													<?php endif; ?>
												<?php endwhile; ?>
											</div>
